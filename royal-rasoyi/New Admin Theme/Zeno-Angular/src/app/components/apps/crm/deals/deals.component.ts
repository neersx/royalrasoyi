 ...
 contacts = [
  ...
  leadCards = [
    ...
    },
    {
      ...
      badgeClass: 'bg-info text-fixed-white'
    },
    {
    ...
    },
    {
      ...
      badgeClass: 'bg-warning text-fixed-white'
    },
    {
      title: 'Deal Finalized',
      count: '127',
      iconClass: 'bg-danger-transparent text-danger',
      borderClass: 'border-danger',
      badgeClass: 'bg-danger text-fixed-white'
    }
  ];
}
