...
@Component({
  ...
  standalone: true,
  imports: [SharedModule,NgApexchartsModule,NgSelectModule,SpkNgSelectComponent,SpkCryptoMarketcapReusableCardComponent],
