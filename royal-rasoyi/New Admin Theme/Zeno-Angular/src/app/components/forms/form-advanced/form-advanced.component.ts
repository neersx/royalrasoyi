...
@Component({
  ...
  standalone: true,
  imports: [SharedModule,AngularDualListBoxModule,FormsModule,ReactiveFormsModule,SpkNgSelectComponent,CdkDropList, CdkDrag,MaterialModuleModule,NgxIntlTelInputModule],
