...
const roundeDefaultALERTS: Alert[] = [
  ...
  {
    type: 'success rounded-pill',
    message: 'A simple rounded success alert—check it out!',
  },
  {
...
shodowClose(index: number) {
 ...
 getVariant(alert: any) {
  ...
  solidroundedAlerts = [
    ...
    { color: 'success rounded-pill', title: 'A simple solid Rounded success alert—check it out!' }, // No shadow
    { color: 'info rounded-pill', title: 'A simple solid Rounded info alert—check it out!' }, // No shadow
  ...
  roundedoutlineAlerts = [
    ...
    { color: 'outline-success rounded-pill', title: 'A simple Rounded outline success alert—check it out!' },
    { color: 'outline-info rounded-pill', title: 'A simple Rounded outline info alert—check it out!' },
  ...
  additionalInfoAlert = [
    ...
    {
      variant: 'info p-0 overflow-hidden',
      title: 'Thank you for reporting this.',
      message: 'We appreciate you letting us know the bug in the template and for warning us about future consequences.',
      linkTitle :'Visit for support for queries ?'
    },
