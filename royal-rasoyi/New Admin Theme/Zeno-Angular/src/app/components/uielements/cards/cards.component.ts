  ...
  featuredCards = [
    ...
    },
    {
      ...
      links: [
        ...
        { text: 'Review', href: 'javascript:void(0);', class: 'text-success m-1 underline-link' }
      ]
    }
  ];
  ...
  groupCard = [
    {
      ...
      text: 'This is a wider card with supporting text below as a natural lead-in to additional content. This card has longer content than first height action.',
