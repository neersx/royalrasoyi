...
import { data } from '../../components/charts/echart-charts/echarts';
...
export let echartHorizontalLineChart: EChartsOption = {
    ...
    color: ['rgb(244, 110, 244)', 'rgb(84, 109, 254)' ]
}
...
export let echartHoriStackedBarChart: EChartsOption = {
    ...
    color: ['rgb(84, 109, 254)', 'rgb(244, 110, 244)', 'rgb(255, 93, 159)']
}
...
export let barLableChart: EChartsOption = {
  ...
  color: ["rgb(84, 109, 254)", "rgb(215, 124, 247)", "#ecb403", "#45aaf2"]
};
...
export let horizontalStackedBarChart: EChartsOption = {
  ...
  color: ["rgb(84, 109, 254)", "rgb(215, 124, 247)", "#ecb403", "#45aaf2", "#ff5b51"]
};
//PIE CHART
...
//Funnel Chart
 export let funnelChart: EChartsOption = {
   ...
   color: ['rgb(84, 109, 254)', 'rgb(215, 124, 247)', '#fbbc0b', '#ee335e', '#49b6f5'],
 };
//Basic Gauge Chart
